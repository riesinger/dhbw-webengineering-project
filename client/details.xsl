							...
							<tr>
									...
									<input type="date" name="eventStartDate" required="required" disabled="disabled">
										<xsl:attribute name="value"><xsl:value-of
											...
											<xsl:if test="//events/event[@ID= //meta/showEvent/ID]/startdate/@day &lt; 10">0<xsl:value-of
												select="//events/event[@ID= //meta/showEvent/ID]/startdate/@day"/>
											</xsl:if>
										</xsl:attribute>
									</input>
								</td>
								...
								<td>
									<input type="time" name="eventStartTime" required="required" disabled="disabled">
										<xsl:attribute name="value">
											<xsl:if test="//events/event[ @ID = //meta/showEvent/ID]/startdate/@hour &lt; 10">0<xsl:value-of
							...
							<tr>
									...
									<input type="date" name="eventEndDate" required="required" disabled="disabled">
										<xsl:attribute name="value"><xsl:value-of
											...
											<xsl:if test="//events/event[@ID= //meta/showEvent/ID]/enddate/@day &lt; 10">0<xsl:value-of
												select="//events/event[@ID= //meta/showEvent/ID]/enddate/@day"/>
											</xsl:if>
										</xsl:attribute>
									</input>
								</td>
								...
								<td>
									<input type="time" name="eventEndTime" required="required" disabled="disabled">
										<xsl:attribute name="value">
											<xsl:if test="//events/event[@ID= //meta/showEvent/ID]/enddate/@hour &lt; 10">0<xsl:value-of
